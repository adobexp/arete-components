...
import static com.adobexp.aem.core.components.models.Image.PN_ALT_VALUE_FROM_DAM;
import static com.adobexp.aem.core.components.models.Image.PN_ALT_VALUE_FROM_PAGE_IMAGE;
import static com.adobexp.aem.core.components.models.Image.PN_IMAGE_FROM_PAGE_IMAGE;
import static com.adobexp.aem.core.components.models.Image.PN_TITLE_VALUE_FROM_DAM;
    ...
    public static Pair<Page, String> resolveRedirects(@Nullable final Page page) {
        ...
        if (page != null && page.getPageManager() != null) {
            ...
            while (result != null && StringUtils
                    .isNotEmpty((redirectTarget = result.getProperties().get("redirectTarget", String.class)))) {
